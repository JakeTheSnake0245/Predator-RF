...
#ifdef PREDATOR_BUILD
      if (opts->audio_in_type == PREDATOR_AUDIO_IN_TYPE) {
        /* Predator: drain one int16 PCM sample from the SDRPP-fed input ring. */
        if (predator_dsd_pull_input_sample(&sample) < 0) {
